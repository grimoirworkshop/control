...
const uint32_t durationTvFirst = 105000;
const uint16_t durationCoin = 10000;
const uint32_t delayBeforeCoin = 103000;
const uint16_t durationBorisVid = 50000;
const uint32_t durationPranksBeforeSoundChange = 118000;
const uint16_t durationVideo31 = 26000;
